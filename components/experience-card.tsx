...
const ExperienceCard: React.FC<Experience> = ({ role, company, companyLink, date, description, skills }) => (
  // ADDED duration-300 for smoother transition
      ...
      <h3 className="font-medium leading-snug text-slate-900 dark:text-slate-200">
        <div>
          ...
          >
            ...
            <span>
              {role} · <span className="inline-block">{company}
                {/* ADDED duration-300 for smoother transition */}
